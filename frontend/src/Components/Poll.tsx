...
const Poll: React.FC<Props> = ({
    ...
    const optionOne: string = PollData.optionOne;
    const optionTwo: string = PollData.optionTwo;
    const poster: string = PollData.posterName;
    ...
    const sendVote = (optionOne: boolean) => {
        ...
        dispatch<any>(addVoteToServer(toSend));
    }
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    function action(arg0: AsyncThunkAction<vote, vote, { state?: unknown; dispatch?: Dispatch<AnyAction> | undefined; extra?: unknown; rejectValue?: unknown; serializedErrorType?: unknown; pendingMeta?: unknown; fulfilledMeta?: unknown; rejectedMeta?: unknown }>): any {
